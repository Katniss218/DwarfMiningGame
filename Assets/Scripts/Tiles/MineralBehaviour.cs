...
{
    public class MineralBehaviour : MonoBehaviour, IHardnessModifier
    {
        ...
        public static void Create( GameObject tile, Mineral data )
        {
            ...
            MineralBehaviour min = tile.AddComponent<MineralBehaviour>();
